...
import pandas as pd
import numpy as np
#Syntax specific to how/where I store reusable scripts/local modules
from local_modules import chartscraper as cs

"""#To set the working directory to the location of chartscraper.py before importing
import os
...
#Skipping chart for 1978-11-13 as at the time it was only displaying the #1
